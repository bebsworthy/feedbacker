/**
 * Shared TypeScript type definitions for Feedbacker
 * Core interfaces and types used across the React widget and Chrome extension
 */
...
// Hook interfaces (used by React widget, but defined here for consistency)
